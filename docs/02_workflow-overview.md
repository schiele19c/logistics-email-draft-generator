...
세부 템플릿 구성 및 조건부 문구 생성 방식은 **template-logic.md**에서 설명합니다.
...
세부 템플릿 구성은 **template-logic.md**를 참고합니다.
...
조건별 문단 조합 방식은 **template-logic.md**에서 설명합니다.
...
날짜 변환 및 템플릿 구성 방식은 **template-logic.md**를 참고합니다.
...
DOA 템플릿의 구성 방식은 **template-logic.md**에서 자세히 설명합니다.
