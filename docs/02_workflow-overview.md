...
각 이메일 유형은 업무 목적에 맞는 독립적인 Workflow를 제공하지만, 전체적인 사용 방식은 동일한 흐름을 따릅니다.

공통 Workflow는 다음과 같습니다.
...
사용자는 필요한 정보만 입력하고, 생성된 이메일을 확인한 뒤 Outlook으로 복사하여 사용할 수 있습니다.

각 이메일 유형은 입력 항목과 템플릿은 다르지만 동일한 사용자 경험을 유지하도록 설계했습니다.

---

## 5.1 PRE-ALERT

PRE-ALERT는 화물 도착 이전 고객에게 운송 일정과 사전 준비 사항을 안내하기 위한 템플릿입니다.

사용 순서는 다음과 같습니다.

1. 화주명, House BL 번호 및 ETA를 입력합니다.

2. 필요한 안내 항목(CARM, POA, HS Code 등)을 선택합니다.

3. 생성된 이메일를 확인합니다.

4. Outlook으로 복사하여 발송합니다.

세부 템플릿 구성 및 조건부 문구 생성 방식은 [03_template-logic.md](03_template-logic.md)에서 설명합니다.

---

## 5.2 Customs Completed

통관 완료 안내는 통관 이후 고객에게 배송 또는 픽업 절차를 안내하기 위한 Workflow입니다.

사용 순서는 다음과 같습니다.

1. 필요한 배송 관련 정보를 입력합니다.

2. 배송지 확인 또는 배송 방식에 맞는 옵션을 선택합니다.

3. 생성된 이메일를 확인합니다.

4. Outlook으로 복사합니다.

세부 템플릿 구성은 [03_template-logic.md](03_template-logic.md)에서 설명합니다.

---

## 5.3 Transportation Invoice

운송 인보이스 안내는 결제와 출고 절차를 고객에게 안내하기 위한 Workflow입니다.
...
조건별 문단 조합 방식은 [03_template-logic.md](03_template-logic.md)에서 설명합니다.

---

## 5.4 Bond Renewal

Bond Renewal은 본드 갱신 안내 이메일 생성 Workflow입니다.
...
날짜 변환 및 템플릿 구성 방식은 [03_template-logic.md](03_template-logic.md)에서 설명합니다.

---

## 5.5 DOA Approval

DOA Approval은 고정된 승인 안내 템플릿을 제공합니다.

사용 순서는 다음과 같습니다.

1. 국문 또는 영문 안내문을 확인합니다.

2. 필요한 언어의 이메일를 복사합니다.

3. Outlook에서 바로 사용할 수 있습니다.

DOA 템플릿의 구성 방식은 [03_template-logic.md](03_template-logic.md)에서 설명합니다.
