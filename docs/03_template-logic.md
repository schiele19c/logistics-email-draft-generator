...
프로젝트 구조와 계층 설계에 대한 자세한 내용은 [04_system-architecture.md](04_system-architecture.md)에서 설명합니다.
...
상태 관리 방식과 설계 배경은 [04_system-architecture.md](04_system-architecture.md)에서 설명합니다.
...
확장 구조와 시스템 설계는 [04_system-architecture.md](04_system-architecture.md)에서 설명합니다.
